...
## NMWC 기획 스킬 (nmwc-plan · nmwc-prd · nmwc-spec)

NMWC 팀이 **같은 규격으로 기획**하고 협업 중 AI slop을 없애기 위한 자체 제작 스킬 꾸러미. 셋을 함께 설치해 쓴다 (nmwc-plan이 공유 인터뷰 게이트·anti-slop·라우팅의 허브).
...
- 설치: `/plugin install nmwc-plan@nmwc-skills` (nmwc-prd·nmwc-spec도 동일). 벤더 심링크 불필요 — 절대경로 의존 없음.
